# utl_classic_editor_hilite_and_evaluate_math_functions
Classic editor hilite and evaluate math functions. Hilite 2**2+3**3 in SAS editor and hit function-key F11 and 31 will appear log.
